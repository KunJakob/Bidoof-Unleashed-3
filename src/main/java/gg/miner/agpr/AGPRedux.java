...
public class AGPRedux extends ConfigurableSpongePlugin {
  ...
  public void onInit(GameInitializationEvent e) {
    ...
    try {
      ...
      this.config = new AbstractConfig(this, new AbstractConfigAdapter(this), new ConfigKeys(),
          "agpredux.conf");
      this.config.init();
  ...
  private void disable() {
    ...
    Sponge.getEventManager().registerListener(this, GameStartedServerEvent.class,
        e -> errorOnStartup());
  }
