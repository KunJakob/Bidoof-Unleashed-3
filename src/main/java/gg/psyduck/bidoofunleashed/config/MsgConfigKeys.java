...
public class MsgConfigKeys implements IConfigKeys {
    ...
    public static final ConfigKey<String> COMMANDS_REMOVE_BADGE_LEADER = StringKey.of("commands.challenge.queued", "{{bu3_prefix}} &7You've taken the {{bu3_badge}} Badge from {{player}}");
    public static final ConfigKey<String> COMMANDS_REMOVE_BADGE_CHALLENGER = StringKey.of("commands.challenge.queued", "{{bu3_prefix}} &7The {{bu3_badge}} Badge has been taken from you");
